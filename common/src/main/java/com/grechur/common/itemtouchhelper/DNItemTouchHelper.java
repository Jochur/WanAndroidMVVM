package com.grechur.common.itemtouchhelper;
 ...
 * <p>
 * By default, DNItemTouchHelper moves the items' translateX/Y properties to reposition them. You can
 ...
 */
public class DNItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    /**
     * DNItemTouchHelper is in idle state. At this state, either there is no related motion event by
    ...
    static final String TAG = "DNItemTouchHelper";
    ...
    /**
     * Set when DNItemTouchHelper is assigned to a RecyclerView.
     */
    ...
    /**
     * Developer callback which controls the behavior of DNItemTouchHelper.
     */
    Callback mCallback;
    ...
    /**
     * Creates an DNItemTouchHelper that will work with the given Callback.
     * <p>
     * You can attach DNItemTouchHelper to a RecyclerView via
     * {@link #attachToRecyclerView(RecyclerView)}. Upon attaching, it will add an item decoration,
     * an onItemTouchListener and a Child attach / detach listener to the RecyclerView.
     *
     * @param callback The Callback which controls the behavior of this touch helper.
     */
    public DNItemTouchHelper(Callback callback) {
        mCallback = callback;
    }
    ...
    /**
     * Attaches the DNItemTouchHelper to the provided RecyclerView. If TouchHelper is already
     * attached to a RecyclerView, it will first detach from the previous one. You can call this
     * method with {@code null} to detach it from the current RecyclerView.
     *
     * @param recyclerView The RecyclerView instance to which you want to add this helper or
     *                     {@code null} if you want to remove DNItemTouchHelper from the current
     *                     RecyclerView.
     */
    ...
    /**
     * Starts dragging the provided ViewHolder. By default, DNItemTouchHelper starts a drag when a
     ...
     * <li>There must be a previous touch event that was reported to the DNItemTouchHelper
    ...
    public void startDrag(ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getParent() != mRecyclerView) {
            Log.e(TAG, "Start drag has been called with a view holder which is not a child of "
                    + "the RecyclerView which is controlled by this DNItemTouchHelper.");
            return;
        }
        obtainVelocityTracker();
        mDx = mDy = 0f;
    ...
    /**
     * Starts swiping the provided ViewHolder. By default, DNItemTouchHelper starts swiping a View
     ...
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * DNItemTouchHelper is attached.</li>
    ...
    public void startSwipe(ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getParent() != mRecyclerView) {
            Log.e(TAG, "Start swipe has been called with a view holder which is not a child of "
                    + "the RecyclerView controlled by this DNItemTouchHelper.");
            return;
        }
        obtainVelocityTracker();
        mDx = mDy = 0f;
     ...
     * {@link DNItemTouchHelper}.
     */
    public interface ViewDropHandler {

        /**
         * Called by the {@link DNItemTouchHelper} after a View is dropped over another View.
         * <p>
    ...
    /**
     * This class is the contract between DNItemTouchHelper and your application. It lets you control
     ...
     * {@link SimpleCallback}.
     * <p>
     * If user drags an item, DNItemTouchHelper will call
     ...
     * custom drop target.
     * <p>
     * When a View is swiped, DNItemTouchHelper animates it until it goes out of bounds, then calls
    ...
    public abstract static class Callback {
        ...
        static {
            if (Build.VERSION.SDK_INT >= 21) {
                sUICallback = new DNItemTouchUIUtilImpl.Api21Impl();
            } else {
                sUICallback = new DNItemTouchUIUtilImpl.BaseImpl();
            }
        }
         ...
         * swiping.
         *
         * @param recyclerView The RecyclerView to which DNItemTouchHelper is attached.
         ...
         *
         * @param recyclerView The RecyclerView to which DNItemTouchHelper is attached to.
        ...
        /**
         * Called when DNItemTouchHelper wants to move the dragged item from its old position to
         * the new position.
         * <p>
         * If this method returns true, DNItemTouchHelper assumes {@code viewHolder} has been moved
        ...
        /**
         * Returns whether DNItemTouchHelper should start a drag and drop operation if an item is
         * long pressed.
         * <p>
         * Default value returns true but you may want to disable this if you want to start
         * dragging on a custom view touch using {@link #startDrag(ViewHolder)}.
         *
         * @return True if DNItemTouchHelper should start dragging an item when it is long pressed,
        ...
        /**
         * Returns whether DNItemTouchHelper should start a swipe operation if a pointer is swiped
         * over the View.
         * <p>
         * Default value returns true but you may want to disable this if you want to start
         * swiping on a custom view touch using {@link #startSwipe(ViewHolder)}.
         *
         * @return True if DNItemTouchHelper should start swiping an item when user swipes a pointer
        ...
        /**
         * When finding views under a dragged view, by default, DNItemTouchHelper searches for views
         ...
         * dragged. After a view is moved this amount, DNItemTouchHelper starts checking for Views
         ...
         * Keep in mind that DNItemTouchHelper also checks the perpendicular velocity and makes sure
        ...
        /**
         * Defines the maximum velocity DNItemTouchHelper will ever calculate for pointer movements.
         * <p>
         * To consider a movement as swipe, DNItemTouchHelper requires it to be larger than the
         ...
         *
         * @param defaultValue The default value(in pixels per second) used by the DNItemTouchHelper.
        ...
        /**
         * Called by DNItemTouchHelper to select a drop target from the list of ViewHolders that
         ...
         * <p>
         * DNItemTouchHelper will keep a reference to the View until it is detached from
         * RecyclerView.
         * As soon as it is detached, DNItemTouchHelper will call
        ...
        /**
         * Called when the ViewHolder swiped or dragged by the DNItemTouchHelper is changed.
         * <p/>
         * If you override this method, you should call super.
         *
         * @param viewHolder  The new ViewHolder that is being swiped or dragged. Might be null if
         *                    it is cleared.
         * @param actionState One of {@link DNItemTouchHelper#ACTION_STATE_IDLE},
         *                    {@link DNItemTouchHelper#ACTION_STATE_SWIPE} or
         *                    {@link DNItemTouchHelper#ACTION_STATE_DRAG}.
         ...
         * <p>
         * DNItemTouchHelper does not create an extra Bitmap or View while dragging, instead, it
         ...
         *
         * @param recyclerView The RecyclerView controlled by the DNItemTouchHelper.
        ...
        /**
         * Called by the DNItemTouchHelper when the user interaction with an element is over and it
         ...
         *
         * @param recyclerView The RecyclerView which is controlled by the DNItemTouchHelper.
        ...
        /**
         * Called by DNItemTouchHelper on RecyclerView's onDraw callback.
         * <p>
         ...
         * <code>dY</code>.
         * DNItemTouchHelper also takes care of drawing the child after other children if it is being
        ...
        /**
         * Called by the DNItemTouchHelper when user action finished on a ViewHolder and now the View
         ...
         *
         * @param recyclerView  The RecyclerView to which the DNItemTouchHelper is attached to.
        ...
        /**
         * Called by the DNItemTouchHelper when user is dragging a view out of bounds.
         * <p>
         ...
         *
         * @param recyclerView        The RecyclerView instance to which DNItemTouchHelper is
         *                            attached to.
     ...
     *
     * <pre>
     * DNItemTouchHelper mIth = new DNItemTouchHelper(
     *     new DNItemTouchHelper.SimpleCallback(DNItemTouchHelper.UP | DNItemTouchHelper.DOWN,
     *         DNItemTouchHelper.LEFT) {
     *         public abstract boolean onMove(RecyclerView recyclerView,
     *             ViewHolder viewHolder, ViewHolder target) {
