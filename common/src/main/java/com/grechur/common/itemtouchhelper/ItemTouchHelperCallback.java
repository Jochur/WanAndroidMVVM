...
public class ItemTouchHelperCallback extends DNItemTouchHelper.Callback {
    public static final int DRAG_FLAGS_HORIZONTAL = DNItemTouchHelper.LEFT | DNItemTouchHelper.RIGHT;
    public static final int DRAG_FLAGS_VERTICAL = DNItemTouchHelper.UP | DNItemTouchHelper.DOWN;
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        return makeMovementFlags(mDragFlags, DNItemTouchHelper.START);
    }
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        if (actionState == DNItemTouchHelper.ACTION_STATE_SWIPE) {
